...
def save_plots(data, normalized_distances, filename, ignore=False):
    ...
    plt.grid(True)
    if ignore:
        file_path = "team_arrow/HPC/Histograms_ignored/" + filename[0:-4] + ".png"
    else:
        file_path = "team_arrow/HPC/Histograms/" + filename[0:-4] + ".png"
    print("Saving plot to:", file_path)  # Debugging: Print the file path
    ...
    plt.grid(True)
    if ignore:
        file_path = "team_arrow/HPC/KDE_ignored/" + filename[0:-4] + ".png"
    else:
        file_path = "team_arrow/HPC/KDE/" + filename[0:-4] + ".png"
    print("Saving plot to:", file_path)  # Debugging: Print the file path
    plt.savefig(file_path,  dpi=600, bbox_inches='tight')
    #plt.show()
